 ...
 */
final class Version20251107123521 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE don ADD CONSTRAINT FK_F8F081D9868C0609 FOREIGN KEY (payement_id) REFERENCES payments (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
